...
export class TmpUniform {
    ...
    @property({ tooltip: CC_DEV && "Text body color", type: cc.Color })
    ...
    @property({ tooltip: CC_DEV && "Text body thickness", range: [0, 1, 0.01] })
    ...
    @property({ tooltip: CC_DEV && "Text body softness", range: [0, 1, 0.01] })
    ...
    @property({ tooltip: CC_DEV && "Whether to enable the stroke effect" })
    ...
    @property({
        tooltip: CC_DEV && "Stroke Thickness",
        range: [0, 1, 0.01],
        visible() { return this._enableOutline; }
    })
    ...
    @property({ tooltip: CC_DEV && "Whether to enable shadow effect" })
    ...
    @property({
        tooltip: CC_DEV && "Shadow Thickness",
        range: [0, 1, 0.01],
        visible() { return this._enableUnderlay; }
    })
    ...
    @property({
        tooltip: CC_DEV && "Shadow Softness",
        range: [0, 1, 0.01],
        visible() { return this._enableUnderlay; }
    })
    ...
    @property({ tooltip: CC_DEV && "Whether to enable the glow effect" })
    ...
    @property({
        tooltip: CC_DEV && "Glow inward thickness",
        range: [0, 1, 0.01],
        visible() { return this._enableGlow; }
    })
    ...
    @property({
        tooltip: CC_DEV && "Glow outward thickness",
        range: [0, 1, 0.01],
        visible() { return this._enableGlow; }
    })
...
@ccclass
@executeInEditMode
@menu("TextMeshPro Components/TextMeshPro")
export default class TextMeshPro extends cc.RenderComponent {
    ...
    @property({ tooltip: CC_DEV && "Font resources\nDo not put the dependent textures into the atlas\nWhen dragging this file in the editor, the texture must be in the same directory as this file", type: cc.JsonAsset })
    ...
    @property({ tooltip: CC_DEV && "How the text is laid out", type: cc.Enum(TmpOverflow) })
    ...
    @property({
        tooltip: CC_DEV && "Whether to enable automatic line wrapping",
        visible() {
    ...
    @property({ tooltip: CC_DEV && "Whether to enable italics" })
    ...
    @property({ tooltip: CC_DEV && "Whether to enable underline" })
    ...
    @property({ tooltip: CC_DEV && "Underline height offset", visible() { return this._enableUnderline; } })
    ...
    @property({ tooltip: CC_DEV && "Whether to enable the Strikethrough" })
    ...
    @property({ tooltip: CC_DEV && "Strikethrough Height Offset", visible() { return this._enableStrikethrough; } })
    ...
    @property({ tooltip: CC_DEV && "Whether to enable color gradient, which will be mixed with vertex color as the final vertex color" })
    ...
    @property({ tooltip: CC_DEV && "Lower left vertex", type: cc.Color, visible() { return this._colorGradient; } })
    ...
    @property({ tooltip: CC_DEV && "Bottom right vertex", type: cc.Color, visible() { return this._colorGradient; } })
    ...
    @property({ tooltip: CC_DEV && "Top left vertex", type: cc.Color, visible() { return this._colorGradient; } })
    ...
    @property({ tooltip: CC_DEV && "Top right vertex", type: cc.Color, visible() { return this._colorGradient; } })
    ...
    @property({ tooltip: CC_DEV && "Material Parameters", type: TmpUniform })
    public tmpUniform: TmpUniform = new TmpUniform();

    @property({ tooltip: CC_DEV && "The texture the font depends on", type: cc.Texture2D, readonly: true })
